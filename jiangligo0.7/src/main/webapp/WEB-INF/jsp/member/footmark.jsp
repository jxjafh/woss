...
<head>
	...
	<style>#BAIDU_DSPUI_FLOWBAR,.adsbygoogle,.ad,div[class^="ad-widsget"],div[id^="div-gpt-ad-"],a[href*="@"][href*=".exe"],a[href*="/?/"][href*=".exe"],.adpushwin{display:none !important;}
	</style>
</head>
	...
	<!-- 主要内容 -->
		<div class="contents" style="padding: 0;transform-origin: 0px 50% 0px; transition: all 0.5s ease;">
			...
			<div class="page a_slow elasticInLeft">
				<!--template 1-->
				<div  class="til"><h3>浏览过的商品</h3></div>
				<div  class="til">
				<c:forEach items="${footmarks }" var="it">
					<div class="box">
